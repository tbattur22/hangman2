defmodule Hangman2Web.Live.Game.Figure do

  use Hangman2Web, :live_component

  def render(assigns) do
    ~H"""
      <div class="figure h-auto">
        <svg version="1.1" id="hangman"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
           ...
           <g id="skyBlue">
            ...
            <path fill="#FFFFFF" d="M16.261,98.073c-1.446-0.771-3.18-0.946-4.57-0.391c-2.651-6.547,5.966-2.745,6.065-8.208
              c4.313-4.675,1.408,6.527,5.593,5.5c2.682-0.658,0.596-3.414,3.915-1.95c1.642,0.723,1.349,2.656,3.981,2.581
              c1.132-3.584,2.434-11.844,7.08-6.599c1.244,1.404,0.812,4.97,1.988,5.84c1.923,1.42,3.651-2.347,5.254-2.37
              c0.862-0.012,0.595,2.279,1.708,2.215c1.715-0.099,1.497-1.022,2.579-2.118c1.273-1.289,1.807-3.314,3.695-3.85
              c5.123-1.452,4.739,5.494,8.719,6.092c0.914,0.138,1.395-1.508,2.723-1.042c0.932,0.327,0.807,2.024,1.644,2.468
              c2.005,1.065,4.039,0.692,5.725-1.329c1.142,1.698,2.896,2.979,3.803,4.832c1.184,0.026,1.396,0.51,2.296,1.1
              c-3.308,3.123-9.621-0.659-13.224,0.648c-0.762,0.277-0.569,2.193-1.57,2.438c-1.244,0.306-1.644-0.673-2.712-1.031
              c-2.293-0.766-3.098-1.836-5.665-0.486c-1.125,0.592-0.83,2.07-2.294,2.235c-1.653,0.187-1.889-1.581-2.871-1.81
              c-2.434-0.564-3.107,1.446-5.412,1.617c-1.891,0.139-3.961-2.046-5.917-1.888c-2.286,0.184-3.995,2.248-6.345,2.422
              c-2.571,0.19-4.843-1.116-7.375-1.344c-2.38-0.214-4.22,0.628-6.501-1.417L16.261,98.073z"/>
           </g><!--end happy landscape-->
           <!--****************
           begin nite-sky
         ****************-->

           <line id="base1" class={"#{hide_show(@tally, -1, :initial_lines)}"} fill="none" stroke="#000000" stroke-width="10" stroke-miterlimit="10" x1="28" y1="326.034" x2="219" y2="326.034"/>
           <line id="base2" class={"#{hide_show(@tally, -1, :initial_lines)}"} fill="none" stroke="#000000" stroke-width="8.6093" stroke-miterlimit="10" x1="171.5" y1="30" x2="171.5" y2="324"/>
           <line id="base3" class={"#{hide_show(@tally, -1, :initial_lines)}"} fill="none" stroke="#000000" stroke-width="8" stroke-miterlimit="10" x1="70.5" y1="34.173" x2="173.5" y2="34.173"/>
           <line id="base4" class={"#{hide_show(@tally, 6, :man)}"} fill="none" stroke="#000000" stroke-width="4.505" stroke-miterlimit="10" x1="72.797" y1="59.357" x2="72.797" y2="35.336"/>

           <g id="man">

           	<g id="base5" class={"#{hide_show(@tally, 5, :man)}"}><!-- this is the mans face-->
           	...
           	<path id="base6" class={"#{hide_show(@tally, 4, :man)}"} fill="none" stroke="#000000" stroke-width="4" stroke-miterlimit="10" d="M73.733,120.504
           		c2.231,6.518,5.267,22.163,3.6,32.496c-1.554,9.634-1.231,15.06-5,21.56"/>

     				<path id="base7" class={"#{hide_show(@tally, 3, :man)}"} d="M75.065,130.611c-2.748,0.216-7.625,0.003-13.268-1.197c-5.647-1.194-12.057-3.245-17.699-6.816
     				...
     				<path id="base8" class={"#{hide_show(@tally, 2, :man)}"} d="M76.791,127.418c2.232,0.218,6.497,0.305,11.459-0.534c4.944-0.822,10.628-2.68,15.177-5.905
      			...
      			<path id="base9" class={"#{hide_show(@tally, 1, :man)}"} d="M74.188,174.161c-2.884,5.522-9.027,17.557-16.091,30.819c-3.535,6.629-7.295,13.566-11.034,20.128
     				...
     				<path id="base10" class={"#{hide_show(@tally, 0, :man)}"} d="M74.167,173.943c4.141,7.45,15.448,27.067,25.586,45.385c2.544,4.57,5.031,9.053,7.249,13.303
           ...
           <g id="happy" class={"#{hide_show(@tally, -1, :happy)}"}>
  ...
  defp hide_show(tally, level, graph) do
    cond do
      graph == :initial_lines -> hide_if_won(tally.game_state)
      graph == :man -> hide_if_left_gt(tally.game_state, tally.turns_left, level)
      graph == :happy -> show_if_won(tally.game_state)
    end
  end

  defp hide_if_left_gt(:won, _left, _level), do: "invisible"
  defp hide_if_left_gt(_game_state, left, level) do
    if (left > level), do: "invisible", else: "visible"
  end

  defp hide_if_won(:won), do: "invisible"
  defp hide_if_won(_), do: "visible"

  defp show_if_won(:won), do: "visible"
  defp show_if_won(_), do: "invisible"
end
